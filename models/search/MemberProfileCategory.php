 ...
 *
 * MemberProfileCategory represents the model behind the search form about `ommu\member\models\MemberProfileCategory`.
 *
...
use ommu\member\models\MemberProfileCategory as MemberProfileCategoryModel;
